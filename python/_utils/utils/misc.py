    ...
    if isinstance(data, dict):
        ...
        for key, value in data.items():
            ...
            if isinstance(value, dict):
                ...
                open_char, close_char = ('[', ']') if isinstance(value, (list, tuple)) else ('{', '}')
                print(f'{open_char}')
                for item in value:
                    if isinstance(item, (dict, list, set, tuple)):
...
def color_print(styles):
    ...
    text_colors = {
        ...
        "bright_white": "\033[97m", "orange": "\033[38;5;202m", "pink": "\033[38;5;205m",
        "lime": "\033[38;5;154m", "teal": "\033[38;5;44m", "purple": "\033[38;5;93m",
        "brown": "\033[38;5;94m", "gold": "\033[38;5;220m", "silver": "\033[38;5;250m",
        "coral": "\033[38;5;210m", "navy": "\033[38;5;17m", "peach": "\033[38;5;216m",
        "ivory": "\033[38;5;230m", "turquoise": "\033[38;5;49m", "emerald": "\033[38;5;40m",
        "charcoal": "\033[38;5;240m", "sky_blue": "\033[38;5;117m", "rose": "\033[38;5;213m",
        "mint": "\033[38;5;122m", "khaki": "\033[38;5;187m", "violet": "\033[38;5;177m",
        "beige": "\033[38;5;230m", "crimson": "\033[38;5;197m", "aqua": "\033[38;5;123m",
        "salmon": "\033[38;5;209m"
    }
    background_colors = {
        "black": "\033[40m", "red": "\033[41m", "green": "\033[42m",
        "yellow": "\033[43m", "blue": "\033[44m", "magenta": "\033[45m",
        "cyan": "\033[46m", "white": "\033[47m", "bright_black": "\033[100m",
        "bright_red": "\033[101m", "bright_green": "\033[102m", "bright_yellow": "\033[103m",
        "bright_blue": "\033[104m", "bright_magenta": "\033[105m", "bright_cyan": "\033[106m",
        "bright_white": "\033[107m", "orange": "\033[48;5;202m", "pink": "\033[48;5;205m",
        "lime": "\033[48;5;154m", "teal": "\033[48;5;44m", "purple": "\033[48;5;93m",
        "brown": "\033[48;5;94m", "gold": "\033[48;5;220m", "silver": "\033[48;5;250m",
        "coral": "\033[48;5;210m", "navy": "\033[48;5;17m", "peach": "\033[48;5;216m",
        "ivory": "\033[48;5;230m", "turquoise": "\033[48;5;49m", "emerald": "\033[48;5;40m",
        "charcoal": "\033[48;5;240m", "sky_blue": "\033[48;5;117m", "rose": "\033[48;5;213m",
        "mint": "\033[48;5;122m", "khaki": "\033[48;5;187m", "violet": "\033[48;5;177m",
        "beige": "\033[48;5;230m", "crimson": "\033[48;5;197m", "aqua": "\033[48;5;123m",
...
def make_serializable(data: Union[Dict[str, Any], List[Any], Any]) -> Union[Dict[str, Any], List[Any], Any]:
    """
