...
def download_file(repository: str, filepath: str, owner: str, token: str='', branch: str='main'):
    """
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to fetch the file. Status code: {response.status_code}, Response: {response.text}")
