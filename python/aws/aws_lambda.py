...
def invoke_lambda(function_name: str, invocation_type: str = 'RequestResponse', payload: Optional[Dict[str, Any]] = None, qualifier: str = '$LATEST', lambda_client: Optional[Any] = lambda_client, region: str = 'us-east-1'):
    if payload is None:
        payload = {}


    print(f"[invoke_lambda] Invoking {function_name} with type {invocation_type} and qualifier {qualifier}")
    try:
