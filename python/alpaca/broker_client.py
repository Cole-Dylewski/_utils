...
class BrokerClient:
    def __init__(
        ...
        api_key,
        api_secret,
        base_url=r"https://broker-api.sandbox.alpaca.markets",
        api_version="v1",
    ):
        """
        ...
        credentials = f"{self.api_key}:{self.api_secret}".encode()
    ...
    def update_account(self, account_id, update_data):
        ...
        return accounts.update_account(
            self.base_url, self.api_version, self.headers, account_id, update_data
        )
    ...
    def get_account_configuration(self, account_id):
        ...
        :return: Response JSON from the API
        """
        return accounts.get_account_configuration(
            self.base_url, self.api_version, self.headers, account_id
        )
    ...
    def update_account_configuration(self, account_id, config_data):
        ...
        :return: Response JSON from the API
        """
        return accounts.update_account_configuration(
            self.base_url, self.api_version, self.headers, account_id, config_data
        )
    ...
    def get_account_activities(self, account_id, activity_type=None):
        ...
        """
        if activity_type:
            return accounts.get_account_activities_by_type(
                self.base_url, self.api_version, self.headers, account_id, activity_type
            )
    ...
    def create_funding_account(self, account_id, funding_data):
        ...
        :return: Response JSON from the API
        """
        return accounts.create_funding_account(
            self.base_url, self.api_version, self.headers, account_id, funding_data
        )
    ...
    def get_ach_relationships(self, account_id):
        ...
        :return: Response JSON from the API
        """
        return accounts.get_ach_relationships(
            self.base_url, self.api_version, self.headers, account_id
        )
    ...
    def delete_ach_relationship(self, account_id, ach_relationship_id):
        ...
        :return: Response JSON from the API
        """
        return accounts.delete_ach_relationship(
            self.base_url, self.api_version, self.headers, account_id, ach_relationship_id
        )
    ...
    def initiate_ach_transfer(self, account_id, transfer_data):
        ...
        :return: Response JSON from the API
        """
        return accounts.initiate_ach_transfer(
            self.base_url, self.api_version, self.headers, account_id, transfer_data
        )
    ...
    def cancel_ach_transfer(self, account_id, transfer_id):
        ...
        :return: Response JSON from the API
        """
        return accounts.cancel_ach_transfer(
            self.base_url, self.api_version, self.headers, account_id, transfer_id
        )
